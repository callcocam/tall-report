...
namespace Tall\Report\Writer\XLSX\Helper;

use DateTimeImmutable;
use Tall\Report\Common\Helper\Escaper\XLSX;
use Tall\Report\Common\Helper\FileSystemHelper as CommonFileSystemHelper;
use Tall\Report\Writer\Common\Entity\Worksheet;
use Tall\Report\Writer\Common\Helper\CellHelper;
use Tall\Report\Writer\Common\Helper\FileSystemWithRootFolderHelperInterface;
use Tall\Report\Writer\Common\Helper\ZipHelper;
use Tall\Report\Writer\XLSX\Manager\Style\StyleManager;
use Tall\Report\Writer\XLSX\MergeCell;
use Tall\Report\Writer\XLSX\Options;
...
{
    public const APP_NAME = 'Tall\Report';
     ...
     *
     * @throws \Tall\Report\Common\Exception\IOException If unable to create the folder
     */
     ...
     *
     * @throws \Tall\Report\Common\Exception\IOException If unable to create the folder or the ".rels" file
     */
     ...
     *
     * @throws \Tall\Report\Common\Exception\IOException If unable to create the file
     */
     ...
     *
     * @throws \Tall\Report\Common\Exception\IOException If unable to create the folder or one of the files
     */
     ...
     *
     * @throws \Tall\Report\Common\Exception\IOException If unable to create at least one of the folders
     */
