...
use Tall\Report\Reader\Exception\IteratorNotRewindableException;
use Tall\Report\Reader\ODS\Helper\CellValueFormatter;
...
final class RowIterator implements RowIteratorInterface
{
     ...
     *
     * @throws \Tall\Report\Reader\Exception\IteratorNotRewindableException If the iterator is rewound more than once
     */
