...
use Tall\Report\Reader\Exception\XMLProcessingException;
use Tall\Report\Reader\Wrapper\XMLReader;
use Tall\Report\Reader\XLSX\Manager\SharedStringsCaching\CachingStrategyFactory;
use Tall\Report\Reader\XLSX\Manager\SharedStringsCaching\CachingStrategyInterface;
...
final class SharedStringsManager
{
     ...
     *
     * @throws \Tall\Report\Common\Exception\IOException If shared strings XML file can't be read
     */
     ...
     *
     * @throws \Tall\Report\Reader\Exception\SharedStringNotFoundException If no shared string found for the given index
     *
     ...
     *
     * @throws \Tall\Report\Common\Exception\IOException If sharedStrings.xml is invalid and can't be read
     *
