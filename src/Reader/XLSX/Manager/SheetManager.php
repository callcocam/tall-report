...
namespace Tall\Report\Reader\XLSX\Manager;

use Tall\Report\Common\Helper\Escaper\XLSX;
use Tall\Report\Reader\Common\Manager\RowManager;
use Tall\Report\Reader\Common\XMLProcessor;
use Tall\Report\Reader\Wrapper\XMLReader;
use Tall\Report\Reader\XLSX\Helper\CellValueFormatter;
use Tall\Report\Reader\XLSX\Options;
use Tall\Report\Reader\XLSX\RowIterator;
use Tall\Report\Reader\XLSX\Sheet;
...
final class SheetManager
{
    ...
    /**
     * @param \Tall\Report\Reader\Wrapper\XMLReader $xmlReader XMLReader object, positioned on a "<workbookPr>" starting node
     *
    ...
    /**
     * @param \Tall\Report\Reader\Wrapper\XMLReader $xmlReader XMLReader object, positioned on a "<workbookView>" starting node
     *
     * @return int A return code that indicates what action should the processor take next
     */
    ...
    /**
     * @param \Tall\Report\Reader\Wrapper\XMLReader $xmlReader XMLReader object, positioned on a "<sheet>" starting node
     *
     * @return int A return code that indicates what action should the processor take next
     */
     ...
     *
     * @param \Tall\Report\Reader\Wrapper\XMLReader $xmlReaderOnSheetNode XML Reader instance, pointing on the node describing the sheet, as defined in "workbook.xml"
     * @param int                                 $sheetIndexZeroBased  Index of the sheet, based on order of appearance in the workbook (zero-based)
     * @param bool                                $isSheetActive        Whether this sheet was defined as active
     *
     * @return \Tall\Report\Reader\XLSX\Sheet Sheet instance
     */
