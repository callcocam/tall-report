...
use Tall\Report\Reader\Exception\InvalidValueException;
use Tall\Report\Reader\RowIteratorInterface;
use Tall\Report\Reader\Wrapper\XMLReader;
use Tall\Report\Reader\XLSX\Helper\CellHelper;
...
final class RowIterator implements RowIteratorInterface
{
     ...
     *
     * @throws \Tall\Report\Common\Exception\IOException If the sheet data XML cannot be read
     */
     ...
     *
     * @throws \Tall\Report\Reader\Exception\SharedStringNotFoundException If a shared string was not found
     * @throws \Tall\Report\Common\Exception\IOException                   If unable to read the sheet data XML
     */
     ...
     *
     *@throws \Tall\Report\Common\Exception\InvalidArgumentException When the given cell index is invalid
     *
