...
use Error;
use Tall\Report\Common\Exception\EncodingConversionException;
...
final class EncodingHelper
{
     ...
     *
     * @throws \Tall\Report\Common\Exception\EncodingConversionException If conversion is not supported or if the conversion failed
     *
