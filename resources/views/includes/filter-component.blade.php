<div class="w-full">
    <div class="flex w-full justify-between items-center px-6 py-2 bg-gray-200">
        ...
        <form class="grid grid-cols-1 sm:grid-cols-7 gap-2 flex-1  items-center">
            ...
            @if ($values = $this->values)
                <div class="col-span-1 sm:col-span-2">
                    @if (data_get($data, 'filter.multiple', false))
                        <x-native-select multiple label="{{ $column }}" wire:model.defer="data.filter.value">
                ...
                <div class="flex items-end space-x-1 col-span-1 mb-2">
                    <x-toggle class="mx-auto" label="{{ __('Multiple') }}" lg
                        wire:model="data.filter.multiple" />
                </div>
                <div class="flex items-end space-x-1 col-span-1 mb-2">
